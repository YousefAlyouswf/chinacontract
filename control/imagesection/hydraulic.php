...
if(isset($_SESSION['log'])){
    ...
    <head>
        ...
        if(isset($_POST['upload'])){
            ...
            for ($i=0; $i<count($_FILES['image']['name']);$i++){
                ...
                $target='../../img/hydraulic/'.$image;

                move_uploaded_file($filetemp, $target);
                $sql="INSERT INTO hydraulic(image) value ('$image')";
    ...
    <div class="container items">
        ...
        <form method="POST" action="hydraulic.php" enctype="multipart/form-data">
    ...
    <div class="container items">
        ...
        while ($row = mysqli_fetch_array($result)){
            echo '<a target="_blank" href="../../img/hydraulic/'.$row['image'].'">';
            echo '<div class=" col-md-4 col-sm-6"><img src="../../img/hydraulic/'.$row['image'].'"width="150" height="150" style="margin: 10px;"></a><a href="deletehydraulic.php?id='.$row['id'].'">Delete</a>';
