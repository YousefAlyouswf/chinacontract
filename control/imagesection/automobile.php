...
.myimg{
    ...
    margin-top: 10px;
        ...
        if(isset($_POST['upload'])){
            ...
            for ($i=0; $i<count($_FILES['image']['name']);$i++){
               ...
               $target='../../img/automobile/'.$image;

               move_uploaded_file($filetemp, $target);
               $sql="INSERT INTO automobilephoto(image) value ('$image')";
    ...
    <body style="background-color: #6666ff;">
        ...
        <ul>
         ...
         <div class="container items">
            ...
            <form method="POST" action="automobile.php" enctype="multipart/form-data">
  ...
  <?php
    ...
    while ($row = mysqli_fetch_array($result)){
        echo '<a target="_blank" href="../../img/automobile/'.$row['image'].'">';
        echo '<div class=" col-md-4 col-sm-6"><img src="../../img/automobile/'.$row['image'].'"width="150" height="150" style="margin: 10px;"></a><a href="deleteauto.php?id='.$row['id'].'">Delete</a>';
