                    ...
                    <div class="container">
                        <div class="content">
                            <div id="rg-gallery" class="rg-gallery">
                                <h1 style="text-align: center">Hydraulic</h1>
                                        ...
                                        <div class="es-carousel">
                                            <ul>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo '<li>
                                                        <a  href="../img/hydraulic/' . $row["image"] . '"><img  src="../img/hydraulic/' . $row['image'] . '" data-large= "../img/hydraulic/' . $row['image'] . '" ></a>
        ...
        <div>
            <div>
                <ul id="menu">
                    ...
                    <li><a href="Aluminum.php">Aluminum Parts</a></li>
                    <li><a href="Automobile.php">Automobile Parts</a></li>
                    <li><a style="color: yellow; font-weight: bold" href="hydraulic.php">Hydraulic Pump Parts</a></li>
                    <li><a href="machinery.php">Machinery Equipment</a></li>
                    <li><a href="powertool.php">Power Tool Parts</a></li>
                    <li><a href="stainless.php">Stainless Parts</a></li>
                    <li><a href="testequipment.php">Test Equipment</a></li>
