                    ...
                    <div class="container">
                        <div class="content">
                            <div id="rg-gallery" class="rg-gallery">
                                <h1 style="text-align: center">Aluminum</h1>
                                        ...
                                        <div class="es-carousel">
                                            <ul>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo '<li>
                                                        <a  href="../img/aluminum/' . $row["image"] . '"><img  src="../img/aluminum/' . $row['image'] . '" data-large= "../img/aluminum/' . $row['image'] . '" ></a>
    ...
    <div class="offcanvas-menu offcanvas-effect visible-xs">
        ...
        <div>
            <div>
                <ul id="menu">
                    <li><a href="../index.php">Home</a></li>
                    <li><a style="color: yellow; font-weight: bold" href="Aluminum.php">Aluminum Parts</a></li>
                    <li><a href="Automobile.php">Automobile Parts</a></li>
                    <li><a href="hydraulic.php">Hydraulic Pump Parts</a></li>
                    <li><a href="machinery.php">Machinery Equipment</a></li>
                    <li><a href="powertool.php">Power Tool Parts</a></li>
