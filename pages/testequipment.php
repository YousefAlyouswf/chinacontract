                            ...
                            <div class="breadcrumb-area">
                                <div class="col-md-6 col-xs-12 col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Test Equipment</li>
                                    </ul>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-6">
                    ...
                    <div class="container">
                        <div class="content">
                            <div id="rg-gallery" class="rg-gallery">
                                <h1 style="text-align: center">Test Equipment</h1>
                                    ...
                                    <div class="es-carousel-wrapper">
                                        ...
                                        <div class="es-carousel">
                                            <ul>
                                                ...
                                                $sql = "SELECT * FROM testequipment";
                                                $result = mysqli_query($connect, $sql);

                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo '<li>
                                                        <a  href="../img/testequipment/' . $row["image"] . '"><img  src="../img/testequipment/' . $row['image'] . '" data-large= "../img/testequipment/' . $row['image'] . '" ></a>
        ...
        <div>
            <div>
                <ul id="menu">
                    ...
                    <li><a href="powertool.php">Power Tool Parts</a></li>
                    <li><a href="stainless.php">Stainless Parts</a></li>
                    <li><a style="color: yellow; font-weight: bold" href="testequipment.php">Test Equipment</a></li>
                    <li><a href="valvebody.php">Valve Body</a></li>
                    <li><a href="contact.php">Contact us</a></li>
