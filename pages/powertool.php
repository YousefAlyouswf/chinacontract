                    ...
                    <div class="container">
                        <div class="content">
                            <div id="rg-gallery" class="rg-gallery">
                                <h1 style="text-align: center">Power Tool</h1>
                                    ...
                                    <div class="es-carousel-wrapper">
                                        ...
                                        <div class="es-carousel">
                                            <ul>
                                                ...
                                                $sql = "SELECT * FROM powertool";
                                                $result = mysqli_query($connect, $sql);

                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo '<li>
                                                        <a  href="../img/powertool/' . $row["image"] . '"><img  src="../img/powertool/' . $row['image'] . '" data-large= "../img/powertool/' . $row['image'] . '" ></a>
        ...
        <div>
            <div>
                <ul id="menu">
                    ...
                    <li><a href="hydraulic.php">Hydraulic Pump Parts</a></li>
                    <li><a href="machinery.php">Machinery Equipment</a></li>
                    <li><a style="color: yellow; font-weight: bold" href="powertool.php">Power Tool Parts</a></li>
                    <li><a href="stainless.php">Stainless Parts</a></li>
                    <li><a href="testequipment.php">Test Equipment</a></li>
                    <li><a href="valvebody.php">Valve Body</a></li>
                    <li><a href="contact.php">Contact us</a></li>
