                            ...
                            <div class="breadcrumb-area">
                                <div class="col-md-6 col-xs-12 col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Stainless Part</li>
                                    </ul>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-6">
                    ...
                    <div class="container">
                        <div class="content">
                            <div id="rg-gallery" class="rg-gallery">
                                <h1 style="text-align: center">Stainless Part</h1>
                                        ...
                                        <div class="es-carousel">
                                            <ul>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo '<li>
                                                        <a  href="../img/stainless/' . $row["image"] . '"><img  src="../img/stainless/' . $row['image'] . '" data-large= "../img/stainless/' . $row['image'] . '" ></a>
        ...
        <div>
            <div>
                <ul id="menu">
                    ...
                    <li><a href="machinery.php">Machinery Equipment</a></li>
                    <li><a href="powertool.php">Power Tool Parts</a></li>
                    <li><a style="color: yellow; font-weight: bold" href="stainless.php">Stainless Parts</a></li>
                    <li><a href="testequipment.php">Test Equipment</a></li>
                    <li><a href="valvebody.php">Valve Body</a></li>
                    <li><a href="contact.php">Contact us</a></li>
                </ul>
