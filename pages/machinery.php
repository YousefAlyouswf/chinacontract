                            ...
                            <div class="breadcrumb-area">
                                <div class="col-md-6 col-xs-12 col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Machinery Equipment</li>
                                    </ul>
                                </div>
                                <div class="col-md-6 col-xs-12 col-sm-6">
                    ...
                    <div class="container">
                        <div class="content">
                            <div id="rg-gallery" class="rg-gallery">
                                <h1 style="text-align: center">Machinery Equipment</h1>
                                        ...
                                        <div class="es-carousel">
                                            <ul>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    echo '<li>
                                                        <a  href="../img/machinery/' . $row["image"] . '"><img  src="../img/machinery/' . $row['image'] . '" data-large= "../img/machinery/' . $row['image'] . '" height="50" width="200" ></a>
        ...
        <div>
            <div>
                <ul id="menu">
                    ...
                    <li><a href="Automobile.php">Automobile Parts</a></li>
                    <li><a href="hydraulic.php">Hydraulic Pump Parts</a></li>
                    <li><a style="color: yellow; font-weight: bold" href="machinery.php">Machinery Equipment</a></li>
                    <li><a href="powertool.php">Power Tool Parts</a></li>
                    <li><a href="stainless.php">Stainless Parts</a></li>
                    <li><a href="testequipment.php">Test Equipment</a></li>
                    <li><a href="valvebody.php">Valve Body</a></li>
